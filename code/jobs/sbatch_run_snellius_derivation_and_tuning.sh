...
#SBATCH --output=/gpfs/home3/ljilesen/intervention-experiment/outputs/logs/derive_tune_%j.out
#SBATCH --error=/gpfs/home3/ljilesen/intervention-experiment/outputs/logs/derive_tune_%j.err
