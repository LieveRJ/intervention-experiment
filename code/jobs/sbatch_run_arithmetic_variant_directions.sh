...
#SBATCH --output=/gpfs/home3/ljilesen/intervention-experiment/outputs/logs/arith_variants_%j.out
#SBATCH --error=/gpfs/home3/ljilesen/intervention-experiment/outputs/logs/arith_variants_%j.err
